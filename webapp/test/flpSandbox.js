		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Title",
									"targetURL": "#stkstarterkit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stkstarterkit-display": {
								"semanticObject": "stkstarterkit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=stk.starterkit",
									"url": sap.ui.require.toUrl("stk/starterkit")
								}
							}
						}
					}
